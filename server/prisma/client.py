...
SCHEMA_PATH = Path('/Users/axdeyy/Documents/Programming/edible/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin': '/Users/axdeyy/.cache/prisma-python/binaries/5.8.0/0a83d8541752d7582de2ebc1ece46519ce72a848/node_modules/prisma/query-engine-darwin'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    posttag: 'actions.PostTagActions[models.PostTag]'
    postimage: 'actions.PostImageActions[models.PostImage]'
    group: 'actions.GroupActions[models.Group]'
    member: 'actions.MemberActions[models.Member]'
    comment: 'actions.CommentActions[models.Comment]'
    postlike: 'actions.PostLikeActions[models.PostLike]'
    commentlike: 'actions.CommentLikeActions[models.CommentLike]'
    ...
    def __init__(
        ...
        *,
        ...
        self.posttag = actions.PostTagActions[models.PostTag](self, models.PostTag)
        self.postimage = actions.PostImageActions[models.PostImage](self, models.PostImage)
        self.group = actions.GroupActions[models.Group](self, models.Group)
        self.member = actions.MemberActions[models.Member](self, models.Member)
        self.comment = actions.CommentActions[models.Comment](self, models.Comment)
        self.postlike = actions.PostLikeActions[models.PostLike](self, models.PostLike)
        self.commentlike = actions.CommentLikeActions[models.CommentLike](self, models.CommentLike)
...
class Batch:
    ...
    posttag: 'PostTagBatchActions'
    postimage: 'PostImageBatchActions'
    group: 'GroupBatchActions'
    member: 'MemberBatchActions'
    comment: 'CommentBatchActions'
    postlike: 'PostLikeBatchActions'
    commentlike: 'CommentLikeBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.posttag = PostTagBatchActions(self)
        self.postimage = PostImageBatchActions(self)
        self.group = GroupBatchActions(self)
        self.member = MemberBatchActions(self)
        self.comment = CommentBatchActions(self)
        self.postlike = PostLikeBatchActions(self)
        self.commentlike = CommentLikeBatchActions(self)
